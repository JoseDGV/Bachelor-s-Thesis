...
// Wed May 19 21:18:18 2021 by ROOT version 6.14/02
// from TTree myTree/My TTree of dimuons
// found on file: OniaTree_Ups1SMM_5p02TeV_TuneCUETP8M1_nofilter_pp502Fall15-MCRUN2_71_V1-v1_GENONLY.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Bool_t          Reco_mu_isGoodMuon[1000];   //[Reco_mu_size]
   Bool_t          Reco_mu_highPurity[1000];   //[Reco_mu_size]
   Bool_t          Reco_mu_TrkMuArb[1000];   //[Reco_mu_size]
   Bool_t          Reco_mu_TMOneStaTight[1000];   //[Reco_mu_size]
   Int_t           Reco_mu_nPixValHits[1000];   //[Reco_mu_size]
   Int_t           Reco_mu_nMuValHits[1000];   //[Reco_mu_size]
   Int_t           Reco_mu_nTrkHits[1000];   //[Reco_mu_size]
   Float_t         Reco_mu_normChi2_inner[1000];   //[Reco_mu_size]
   Float_t         Reco_mu_normChi2_global[1000];   //[Reco_mu_size]
   Int_t           Reco_mu_nPixWMea[1000];   //[Reco_mu_size]
   Int_t           Reco_mu_nTrkWMea[1000];   //[Reco_mu_size]
   Int_t           Reco_mu_StationsMatched[1000];   //[Reco_mu_size]
   Float_t         Reco_mu_dxy[1000];   //[Reco_mu_size]
   Float_t         Reco_mu_dxyErr[1000];   //[Reco_mu_size]
   Float_t         Reco_mu_dz[1000];   //[Reco_mu_size]
   Float_t         Reco_mu_dzErr[1000];   //[Reco_mu_size]
   Float_t         Reco_mu_pt_inner[1000];   //[Reco_mu_size]
   Float_t         Reco_mu_pt_global[1000];   //[Reco_mu_size]
   Float_t         Reco_mu_ptErr_inner[1000];   //[Reco_mu_size]
   Float_t         Reco_mu_ptErr_global[1000];   //[Reco_mu_size]
   Int_t           Gen_QQ_size;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Acceptance.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Acceptance.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("Acceptance.root:/hionia");
